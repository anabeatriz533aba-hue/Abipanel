    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .side-menu {
            position: fixed;
            top: 0;
            left: -85%; /* Mobilde %85 genişlik */
            width: 85%;
            max-width: 380px; /* Masaüstünde max 380px */
            height: 100vh;
            background: #0a0c12;
...
<body>
    ...
    <script>
        ...
        // Menü içindeki tıklamaların dışarıya taşmasını engelle
...
# ========== MARKET SAYFASI KALDIRILDI ==========
# (Market sayfası tamamen kaldırıldı)
...
# MARKET SAYFASI KALDIRILDI - URL yönlendirmesi
@app.route('/market')
@login_required
def market_page():
    return redirect(url_for('home'))
