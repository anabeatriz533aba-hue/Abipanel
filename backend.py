    ...
    <script>
        ...
        function createInputs() {
            ...
            if (type === 'tc' || type === 'ailepro' || type === 'adres' || type === 'serino_tc' || 
                endpoint.includes('nufus') || endpoint.includes('asi') || endpoint.includes('rontgen') ||
                endpoint.includes('recete') || endpoint.includes('adli') || endpoint.includes('pasaport') ||
                endpoint.includes('kronik') || endpoint.includes('vergi_borc') || endpoint.includes('tapu') ||
                endpoint.includes('askerlik') || endpoint.includes('fatura') || endpoint.includes('otel') ||
                endpoint.includes('istanbulkart') || endpoint.includes('spor') || endpoint.includes('kutuphane') ||
                endpoint.includes('hasta') || endpoint.includes('dijital') || endpoint.includes('kredi') ||
                endpoint.includes('meb') || endpoint.includes('ticaret') || endpoint.includes('sehirlerarasi') ||
                endpoint.includes('noter') || endpoint.includes('ormancilik') || endpoint.includes('ucak') ||
                endpoint.includes('seyahat')) {
                
                html += '<div class="param-group">';
                html += '<label>TC Kimlik No</label>';
                html += '<input type="text" id="tc" placeholder="11 haneli TC" maxlength="11">';
                html += '</div>';
                
            } else if (type === 'ad' || type === 'adsoyadpro') {
                html += '<div class="param-group">';
                html += '<label>Ad</label>';
                html += '<input type="text" id="ad" placeholder="Ad">';
                html += '</div>';
                html += '<div class="param-group">';
                html += '<label>Soyad</label>';
                html += '<input type="text" id="soyad" placeholder="Soyad">';
                html += '</div>';
                
                if (type === 'adsoyadpro') {
                    html += '<div class="param-group">';
                    html += '<label>İl (opsiyonel)</label>';
                    html += '<input type="text" id="il" placeholder="İl">';
                    html += '</div>';
                }
                
            } else if (type === 'gsm' || type === 'operator') {
                html += '<div class="param-group">';
                html += '<label>GSM Numarası</label>';
                html += '<input type="text" id="gsm" placeholder="5xxxxxxxxx">';
                html += '</div>';
                
            } else if (type === 'plaka') {
                html += '<div class="param-group">';
                html += '<label>Plaka</label>';
                html += '<input type="text" id="plaka" placeholder="34ABC34" style="text-transform:uppercase">';
                html += '</div>';
                ...
                html += '<div class="param-group">';
                html += '<label>Papara Numarası</label>';
                html += '<input type="text" id="papara_no" placeholder="Papara No">';
                html += '</div>';
                ...
                html += '<div class="param-group">';
                html += '<label>İsim</label>';
                html += '<input type="text" id="isim" placeholder="İsim">';
                html += '</div>';
                
            } else if (type === 'vergi_no') {
                html += '<div class="param-group">';
                html += '<label>Vergi Numarası</label>';
                html += '<input type="text" id="vergi_no" placeholder="Vergi No">';
                html += '</div>';
                
            } else if (type === 'vergi_detay') {
                html += '<div class="param-group">';
                html += '<label>İlçe</label>';
                html += '<input type="text" id="ilce" placeholder="İlçe">';
                html += '</div>';
                html += '<div class="param-group">';
                html += '<label>Vergi Dairesi</label>';
                html += '<input type="text" id="vergi_dairesi" placeholder="Vergi Dairesi">';
                html += '</div>';
                ...
                html += '<div class="param-group">';
                html += '<label>Seri No</label>';
                html += '<input type="text" id="seri_no" placeholder="Örn: A30T00779">';
                html += '</div>';
                
            } else if (type === 'iban') {
                html += '<div class="param-group">';
                html += '<label>IBAN</label>';
                html += '<input type="text" id="iban" placeholder="TR ile başlayan IBAN">';
                html += '</div>';
        ...
        async function search() {
            ...
            if (type === 'tc' || type === 'ailepro' || type === 'adres' || type === 'serino_tc' || 
                ...
                if (!ilce && !vergi_dairesi) { 
                    alert('İlçe veya vergi dairesi giriniz'); 
                    return; 
                }
