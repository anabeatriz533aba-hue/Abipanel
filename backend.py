...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .blue-tick { color: #3b82f6; font-size: 14px; }
        .online-status {
            display: flex;
            align-items: center;
            gap: 6px;
        ...
        /* Yeni Çözümler kategorisi için parlama efekti */
        ...
        .stat-label { font-size: 12px; color: #a0a0ab; }
...
<body>
    ...
    <div class="side-menu" id="sideMenu">
        ...
        <div class="menu-categories">
            <!-- YENİ ÇÖZÜMLER - Parlama efektli -->
            <div class="category-block new-solutions">
                <div class="category-header" onclick="toggleCategory(this)">
                    <i class="fas fa-fire"></i> Premium ÇÖZÜMLER
                    <i class="fas fa-chevron-down arrow"></i>
                </div>
                <ul class="query-list">
                    <li class="query-item" onclick="goToQuery('papara_no', 'papara_no')"><i class="fas fa-money-bill"></i> Papara Sorgula (No ile)</li>
            ...
            <div class="category-block">
                <div class="category-header" onclick="toggleCategory(this)">
                    <i class="fas fa-landmark"></i> Vergi Dairesi Sorguları
                    <i class="fas fa-chevron-down arrow"></i>
                </div>
                <ul class="query-list">
    ...
    <div class="content">
        <div class="welcome-box">
            ...
            <p style="margin-top:20px; color:#ffcc00; text-shadow:0 0 10px rgba(255,204,0,0.3);">🔥 Premium çözümler eklendi!</p>
            {% else %}
...
if __name__ == '__main__':
    ...
    print("📋 MONGODB: Bağlı")
    print("📱 MOBİL UYUMLU: Menü 300px, dark panel teması")
    print("🔥 YENİ: Premium Çözümler parlama efektli")
    print("\n🌐 http://localhost:5000")
    print("="*60)
